...
namespace ObjectDetection
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var assetsPath = GetAbsolutaPath(assetsRelativePath);
            ...
            try
            {
                ...
                var boundingBoxes = probabilities
                    .Select(probability => parser.ParseOutput(probability))
        ...
        public static string GetAbsolutaPath(string relativePath)
        {
